package iuh.fit.se.inventoryservice.exception;
...
public enum ErrorCode {
        ...
        SystemUser_NOT_FOUND(1021, "Customer not found", HttpStatus.NOT_FOUND),
        ORDER_STATUS_INVALID(1022, "Order status invalid", HttpStatus.BAD_REQUEST),
        PAYMENT_STATUS_INVALID(1023, "Payment status invalid", HttpStatus.BAD_REQUEST),
        ...
        OUT_OF_STOCK(4006, "Out of stock", HttpStatus.BAD_REQUEST),
        CREATE_DIRECTORY_FAILED(4005, "Create directory failed", HttpStatus.INTERNAL_SERVER_ERROR),

        TIME_OUT(5000, "Time out", HttpStatus.REQUEST_TIMEOUT);
